...
import (
	...
	"github.com/abhishek622/moviedock/rating/internal/repository"
...
func (c *Controller) DeleteRating(ctx context.Context, userID model.UserID) error {
	return c.repo.Delete(ctx, userID)
}
